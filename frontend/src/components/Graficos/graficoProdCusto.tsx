...
import { DadosAgrupadosValor, DataValor, estatisticasServices } from "../../services/estatisticasServices";
...
const GraficoProdCusto: React.FC = () =>{
    ...
    const fetchData = async () => {
        const result = await estatisticasServices.getProdCusto()
    ...
    return (
        <>
            <div className="graph-header">
                <h4>Produtos com maior Custo </h4>
            ...
            <ResponsiveContainer width="100%" height={600} className={"responsive-pie"}>
                <PieChart  margin={{ top: 0, right: 0, left:0, bottom: 0 }}>
                    <Pie data={data} dataKey="ValorTot" cx="50%" cy="50%" outerRadius={150} fill="#8884d8" nameKey={filter} label={undefined}>
...
export default GraficoProdCusto